...
file_put_contents("requestLog.txt", json_encode($_REQUEST));
file_put_contents("sessionLog.txt", json_encode($_SESSION));

echo "Inity ".__LINE__."<pre>";print_r($_REQUEST);echo "</pre>";

}
//add_action( 'wp', 'logData');
